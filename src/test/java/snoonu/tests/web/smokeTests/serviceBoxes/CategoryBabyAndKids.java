...
import static snoonu.tests.TestData.BabyAndKids;

@Tag("smoke")
@Tag("categories")
class CategoryBabyAndKids extends TestBase {
    ...
    void babyAndKids() {
        ...
        step("Go to Baby & Kids", () -> {
            goToBabyAndKids();
        });

        step("Assert: URL contains 'snoonu-market/baby-and-kids'", () -> {
            assertPageOpened(BabyAndKids);
        });
