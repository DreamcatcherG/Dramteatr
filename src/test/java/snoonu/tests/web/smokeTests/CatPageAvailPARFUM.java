...
@Tag("smoke")
class CatPageAvailPARFUM extends TestBase {


    @Test
    void catPageAvailPARFUM() {
        ...
        step("Go to category of beauty and perfumes", () -> {
            ...
            $(byAttribute("data-analytic-event-content", "Beauty and Perfumes")).click();

        });

        step("Assert: URL contains 'beauty-and-perfumes'", () -> {

            String expectedUrlPart = "https://snoonu.com/beauty-and-perfumes";
        ...
        step("Assert: the page is opened", () -> {
            ...
            $("body").shouldHave(text("Beauty & Fragrance"));
